/*--buyerdashboard-graph-start---*/
/*--rfq-chart-start--*/

document.addEventListener("DOMContentLoaded", function () {
    var c = document.querySelector("#rfqchart"),
        d = {
            chart: {
                height: 300,
                type: "donut"
            },
            labels: ["RFQ", "Excutive", "Deleted", "Modified"],
            series: [42, 8, 25, 25],
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (weeklyEarningReportsElement) {
        const weeklyEarningReportsOptions = {
            ...
            series: [{ data: [40, 65, 50, 45, 90, 55, 70, 10, 20, 30, 40, 70] }],
            legend: { show: false },
            xaxis: {
