...
Route::middleware('admin.auth')->group(function () {
    ...
    // category
     ...
     Route::get('/brands/create', [CategoryController::class, 'showBrandCreateForm'])->name('admin.brand.create.form');
     Route::post('/brands/create', [CategoryController::class, 'createBrand'])->name('admin.brand.create');
     Route::get('/brands/edit/{id}', [CategoryController::class, 'editBrand'])->name('admin.brand.edit');
     Route::put('/brands/update/{id}', [CategoryController::class, 'updateBrand'])->name('admin.brand.update');

     Route::delete('/brands/delete/{id}', [CategoryController::class, 'destroyBrand'])->name('admin.brand.delete');
