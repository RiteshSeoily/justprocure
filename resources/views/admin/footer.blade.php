  ...
  <div class="container pb80">
    <div class="row mt40">
      <div class="col-sm-6 col-md-3 col-lg-2 col-xl-2">
        <div class="footer-logo-new-homepage">
          <img src="images/new-images/footer-logo.png">
        </div>
        ...
        <div class="footer_contact_widget">
          ...
          <div class="footer_contact_iconbox d-flex mb-4">
            ...
            <div class="details ms-4">
              ...
              <a href="#">+91-9166281425</a> </div>
          </div>
          <div class="footer_contact_iconbox d-flex">
            <div class="icon"><span><i class="fa fa-envelope" aria-hidden="true"></i></span></div>
            <div class="details ms-4">
              <h5 class="title">Need help with your order?</h5>
              <a href="#">info@justprocure.com</a> </div>
          </div>
      ...
      <div class="col-sm-8 col-md-5 col-lg-3 col-xl-3">
        <div class="mailchimp_widget mb30">
          <div class="details">
            <h4 class="mb-4 color-white">Subscribe</h4>
            <div class="footer_social_widget">
              <form class="footer_mailchimp_form home5 at_home6 home9_style">
        ...
        <div class="footer_acceped_card_widget">
          ...
          <div class="acceped_card_list">
            <ul class="d-flex mb-0">
              ...
              <li class="me-2"><a href="#"><img src="images/resource/apple-pay.png" alt="apple-pay"></a></li>
              <li class="me-2"><a href="#"><img src="images/resource/discover-card.png" alt="discover-card"></a></li>
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="copyright-widget text-center text-lg-start d-block d-lg-flex mb15-md">
          <p class="me-4">© 2024 justProcure. All Rights Reserved</p>
          <p><a href="#">Privacy</a> · <a href="#">Terms</a> · <a href="#">Sitemap</a></p>
        </div>
      </div>
      <div class="col-lg-6">
        <div class="footer_bottom_right_widgets home6_style text-center text-lg-end">
          <div class="design-and-develop">
           <p> Design & Develop by</p>
          <a href="https://www.seoily.com/"> <img src="images/new-images/seoily-logo.png"> </a>
          </div>
          <!--<ul class="mb0">
