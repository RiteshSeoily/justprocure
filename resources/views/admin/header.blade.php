              ...
              <ul class="mb0">
                <li class="list-inline-item">
                  <a class="header_top_iconbox" href="page-account-wishlist.html">
                    <div class="d-block d-md-flex">
                      <div class="icon"><span><i class='far fa-heart'></i></span></div>
                      <div class="details">
                ...
                <li class="list-inline-item">
                  <a class="header_top_iconbox signin-filter-btn" href="login.html">
                    <div class="d-block d-md-flex">
                      <div class="icon"><span><i class="fa fa-user" aria-hidden="true"></i></span></div>
                      <div class="details">
  ...
  <header class="header-nav menu_style_home_one main-menu">
    ...
    <nav class="posr"> 
      <div class="container posr menu_bdrt1"> 
              ...
              <li class="col mega_menu_list">
                <div class="banner_one megamenu_style home1_style color1 mb30">
                  <div class="thumb style1">
                    <img class="float-end" src="images/banner/smartwatch.png" alt="smartwatch">
                  </div>
                  <div class="details">
                ...
                <div class="banner_one megamenu_style home1_style color1">
                  <div class="thumb">
                    <img class="float-end" src="images/banner/earphone.png" alt="EarPhone">
                  </div>
                  <div class="details">
                    <p class="para color-light-blue">Starting from <span class="fw500">$899.</span></p>
        ...
        <li class="list-inline-item list_c"><a class="become-vendor" href="become-vendor">Register as a Vendor</a></li>
        </ul>
      </div>
    </nav>
  </header>
            ...
            <li class="list-inline-item">
              <ul class="dropdown_content">
                <li class="list_content">
                  <div>
                    <img class="float-start mt10" src="images/shop/s1.png" alt="75x75">
                    ...
                    <div class="cart_btn home_page_sidebar mt10">
                      <div class="quantity-block home_page_sidebar">
                        <button class="quantity-arrow-minus home_page_sidebar"><img src="images/icons/minus.svg" alt=""></button>
                ...
                <li class="list_content">
                  <div>
                    <img class="float-start mt10" src="images/shop/s2.png" alt="75x75">
                    <p>Apple MacBook Pro with Apple M1 Chip</p>
                    <div class="cart_btn home_page_sidebar mt10">
                      <div class="quantity-block home_page_sidebar">
                        <button class="quantity-arrow-minus2 home_page_sidebar"><img src="images/icons/minus.svg" alt=""></button>
                        <input class="quantity-num2 home_page_sidebar" type="number" value="3">
                        <button class="quantity-arrow-plus2 home_page_sidebar"> <span class="flaticon-close"></span> </button>
                      </div>
                      <span class="home_page_sidebar price">$3.399</span>
                    </div>
                    <span class="close_icon"><i class="flaticon-close"></i></span>
  ...
  <div id="page" class="stylehome1">
      ...
      <div class="header stylehome1">
        <div class="menu_and_widgets">
          <div class="mobile_menu_bar float-start">
            ...
            <a class="mobile_logo" href="#"><span class="text-thm"><img src="images/images/logo.jpg"></span></a>
          </div>
          <div class="mobile_menu_widget_icons">
            <ul class="cart mt15">
              <li class="list-inline-item">
                <a class="cart_btn signin-filter-btn" href="#"><span class="icon"><i class="fa fa-user" aria-hidden="true"></i></span></a>
              </li>
              <li class="list-inline-item">
                <a class="cart_btn cart-filter-btn" href="#"><span class="icon"><img src="images/icons/flaticon-shopping-cart-white.svg" alt=""></span><span class="badge bgc-thm">2</span></a>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div class="header_middle_advnc_search">
            <div class="container search_form_wrapper">
              <div class="row">
                ...
                <div>
                  <div class="advscrh_frm_btn">
                    <button type="submit" class="btn search-btn"><span><i class="fa fa-search" aria-hidden="true"></i></span></button>
                  </div>
                </div>
              </div>
            </div>
    ...
    <nav id="menu" class="stylehome1">
      <ul>
        ...
        <li><span><i class="fa fa-cutlery mr20"></i>Home & Kitchen</span>
          <ul>
            <li><a href="#">Home & Kitchen</a></li>
          </ul>
        </li>
        <li><span><i class='fas fa-bed mr20'></i>Home & Furniture</span>
          <ul>
            <li><a href="#">Home & Furniture</a></li>
          </ul>
        </li>
        <li><span><i class='fas fa-desktop mr20'></i>Electronics</span>
          <ul>
            <li><a href="#">Electronics</a></li>
          </ul>
        </li>
        <li><span><i class='fas fa-tshirt mr20'></i>Clothing & Accessories</span>
          <ul>
            <li><a href="#">Clothing & Accessories</a></li>
          </ul>
        </li>
        <li><span><i class='fas fa-h-square mr20'></i>Health & Beauty</span>
          <ul>
            <li><a href="#">Health & Beauty</a></li>
          </ul>
        </li>
        <li><span><i class='far fa-futbol mr20'></i>Sport & Outdoor</span>
          <ul>
            <li><a href="#">Sport & Outdoor</a></li>
          </ul>
        </li>
        <li><span><i class="fa fa-shopping-basket mr20"></i>Grocery & Market</span>
          <ul>
            <li><a href="#">Grocery & Market</a></li>
          </ul>
        </li>
        <li><span><i class='fas fa-gamepad mr20'></i>Toy & Video Games</span>
          <ul>
            <li><a href="#">Toy & Video Games</a></li>
          </ul>
        </li>
        <li><span><i class='fas fa-baby mr20'></i>Babies & Moms</span>
          <ul>
