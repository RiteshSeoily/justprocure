...
<div class="col-xl-12">
   <div class="admin-dashboard-searchbar-radio-button-outer">
      <div class="radio-button-admin-dashboard-outer">
         <form class="radio-button-admin-dashboard" id="filterForm">
...
<script>
   $(document).ready(function() {
       $('input[type="radio"]').change(function() {
           ...
           if (filterValue === 'all') {
               $('.buyer-dashboard-recent-activity-table-outer').show();
           } else {
               $('.buyer-dashboard-recent-activity-table-outer').hide();
               $('.buyer-dashboard-recent-activity-table-outer[data-gst="' + filterValue + '"]').show();
           }
       });
