                                    ...
                                    <tbody>
                                        @foreach($buyers as $index => $buyer)
                                            <tr class="buyer-dashboard-recent-activity-table-outer">
                                                ...
                                                <td class="buyer-dashboard-right-border">{{ $buyer->rfq_numbery }}</td>
                                                <td class="buyer-dashboard-right-border">{{ $buyer->orders }}</td>
                                                <td class="editing_list align-middle">
                                                <ul>
                                                <li class="list-inline-item mb-1">
                                                    <a href="{{ route('admin.addresses.byUserId', ['id' => $buyer->id]) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="View" aria-label="View"><i class="fa fa-eye"></i></a>
                                                </li>
                                                 <li class="list-inline-item mb-1">
                                                <a href="{{ route('admin.buyers.edit', ['id' => $buyer->id]) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" aria-label="Edit"><i class="fa fa-pen" aria-hidden="true"></i></a>
                                                  </li>
                                               <li class="list-inline-item mb-1">
                                            <button class="delete-buyer-btn" data-id="{{ $buyer->id }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" aria-label="Delete" style="border:none;background:none;"><i class="fa fa-trash" aria-hidden="true"></i></button>
                                                    </li>
                                                      </ul>
                                                </td>
                                            </tr>
